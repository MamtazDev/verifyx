  ...
  return (
    <div className="v_main_page h-screen ">
      <div className="container">
        ...
        {/* singin/singup */}
        <h4 className="title-style">Get Started</h4>
        {/* singin/singup -/end */}
        <div className="btn_wrapper flex flex-col gap-[38px] lg:gap-4 items-center">
          <Link
            to={"/create-account"}
            className="inline-block w-full lg:w-[288px] py-[21px] lg:py-[18px] shadow-shadowOne text-center text-lg font-medium rounded-[25px] bg-[#4171FC] text-white"
          >
            Sign up
          </Link>
          <Link
